<?php  include './config-project/databaseValues.php';
...
$config['mongo_db']['default']['hostname'] = $dbhost;
$config['mongo_db']['default']['port'] = $dbport;
$config['mongo_db']['default']['username'] = $dbUserName;
$config['mongo_db']['default']['password'] = $dbPassword;
$config['mongo_db']['default']['database'] = $databaseName;
$config['mongo_db']['default']['server_type'] = $servertype;
