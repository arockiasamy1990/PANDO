...
/*
  ...
  |
 */
if (is_file("config-project/dectar_app_settings.php")) {
	require_once "config-project/dectar_app_settings.php";
}else{
	define('APP_NAME','pando');
	$config['encryption_key']='SDF43SDFtgfrvv8j79y36482DF489sdf26FSDF8df249df5gh814tjSDF87JGHJUy345';
...
$config['csrf_token_name'] = '48486412343244141324';
$config['csrf_cookie_name'] = '45fdsc541fcd415fdsc154dsgc541dsfc';
...
|
| Array:		array('localhost','192.168.1.251:8081', 'project.dectar.com')
|
*/

$config['trusted_hosts'] = array('localhost');
